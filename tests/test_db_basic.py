...
def test_move_entry_changes_path_keeps_row_count(tmp_path):
    m, db = _fresh_db(tmp_path)
    m.upsert_entry("pending_review/应急哨兵.md", "concept", "应急哨兵", "产品", "pending", "V2.1", "fp123", "2026-08-13")
    ...
    with m.get_conn() as conn:
        ...
        assert row == ("NEXUS/概念/应急哨兵.md", "concept", "应急哨兵", "产品", "active", "V2.1", "fp123", "2026-08-13")
